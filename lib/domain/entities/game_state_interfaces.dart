...
class StatisticsManager with ChangeNotifier {
  ...
  Map<String, Map<String, dynamic>> getAllStats() {
    return {
      'production': {
        ...
        'M̩tal Utilis̩': _formatNumber(_totalMetalUsed),
      },
      'economie': {
        'Argent Gagn̩': _formatNumber(_totalMoneyEarned),
        'Argent D̩pens̩': _formatNumber(_totalMoneySpent),
        'M̩tal Achet̩': _formatNumber(_totalMetalBought),
        'Ventes Totales': _formatNumber(_totalSales),
        'Prix Max': _formatNumber(_highestPrice),
        'Prix Moyen': _formatNumber(_averagePrice),
      },
      'progression': {
        'Am̩liorations Achet̩es': _totalUpgradesBought,
        'Autoclippers Achet̩s': _totalAutoclippersBought,
  ...
  void fromJson(Map<String, dynamic> json) {
    try {
      // Conversion s̩curis̩e avec logs
  ...
  // M̩thodes utilitaires pour conversion s̩curis̩e
