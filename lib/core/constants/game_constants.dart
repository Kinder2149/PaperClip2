...
class GameConstants {
  ...
  // Ã€ ajouter dans une nouvelle section "AmÃ©liorations"
  ...
  // Constantes pour les amÃ©liorations
  ...
  // Niveaux maximum des amÃ©liorations
...
//Crise passagÃ¨re
  ...
  // Bonus des amÃ©liorations (en pourcentage)
  static const double SPEED_BONUS_PER_LEVEL = 0.20;    // +20% vitesse
  static const double BULK_BONUS_PER_LEVEL = 0.35;     // +35% quantitÃ©


  // Facteurs de rÃ©putation
...
enum GameMode {
  ...
  COMPETITIVE  // Mode compÃ©titif, avec focus sur les statistiques et scores
}
