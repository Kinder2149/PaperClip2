...
class RuntimeWatchdog {
  ...
  static final Logger _logger = Logger.forComponent('watchdog');
  ...
  static void _alert(String code, Map<String, Object?> data) {
    ...
    if (kDebugMode) {
      _logger.warn('[watchdog][ALERT] $code $data', code: code, ctx: data);
    }
  }

  static void _log(String code, Map<String, Object?> data) {
    if (kDebugMode) {
      _logger.debug('[watchdog] $code $data', code: code, ctx: data);
    }
  }
}
