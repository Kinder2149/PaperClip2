...
class NotificationStorageService {
  static final Logger _logger = Logger.forComponent('notif-storage');
  ...
  static Future<void> saveImportantNotification(NotificationEvent notification, String gameName) async {
    try {
      ...
      _logger.warn('Erreur lors de la sauvegarde de la notification: $e', code: 'save_error');
    }
  }
  ...
  static Future<List<NotificationEvent>> getNotificationsForGame(String gameName) async {
    try {
      ...
      _logger.warn('Erreur lors de la récupération des notifications: $e', code: 'get_error');
      return [];
    }
  }
  ...
  static Future<List<NotificationEvent>> getImportantNotifications() async {
    try {
      ...
      _logger.warn('Erreur lors de la récupération des anciennes notifications: $e', code: 'legacy_get_error');
      return [];
    }
  }
  ...
  static Future<void> migrateOldNotifications(String gameName) async {
    try {
      ...
      if (oldNotifications.isNotEmpty) {
        ...
        _logger.info('Migration des anciennes notifications réussie', code: 'migrate_ok', ctx: {'game': gameName});
      }
    } catch (e) {
      _logger.warn('Erreur lors de la migration des notifications: $e', code: 'migrate_error');
    }
  }
  ...
  static Future<int> getNotificationCount(String gameName) async {
    try {
      ...
      _logger.warn('Erreur lors du comptage des notifications: $e', code: 'count_error');
      return 0;
    }
  }
}