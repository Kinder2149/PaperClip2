...
class _SaleRecordView {
  final DateTime timestamp;
  final int quantity;
  final double price;
  final double revenue;

  const _SaleRecordView({
...
class _SalesHistoryView {
  final List<_SaleRecordView> sales;
...
class SalesHistoryScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Selector<GameState, _SalesHistoryView>(
        selector: (context, gameState) {
          final salesSrc = gameState.market.salesHistory;
          final sales = salesSrc
              .map((s) => _SaleRecordView(
  ...
  Widget _buildSaleCard(_SaleRecordView sale) {
