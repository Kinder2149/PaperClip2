                      ...
                      Row(
                        children: [
                          _buildResourceCard(
                            ...
                            onTap: () =>
                                _showInfoDialog(
                                  context,
                                  'Statistiques de Production',
                                  'Total produit: ${NumberFormatter.formatNumber(
                          ...
                          _buildResourceCard(
                            'Stock Trombones',
                            NumberFormatter.formatNumber(
                                gameState.player.paperclips.toDouble(),
                                isInteger: true),
                            ...
                            onTap: () =>
                                _showInfoDialog(
                                  context,
                                  'Stock de Trombones',
                                  'Total en stock: ${NumberFormatter.formatNumber(
                                      gameState.player.paperclips.toDouble(),
                                      isInteger: true)}\n'
                                      'Production totale: ${NumberFormatter
                                      .formatNumber(
                                      gameState.totalPaperclipsProduced
                                          .toDouble(), isInteger: true)}',
                                ),
