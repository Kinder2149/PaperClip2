              ...
              Expanded(
                child: ListView(
                  ...
                  children: [
                    ...
                    // Section Sauvegardes (en premier)
                    Card(
                      elevation: 0,
                    ...
                    // Section Informations (inclut Statistiques et Version)
                    Card(
                      elevation: 0,
                      color: Colors.grey[50],
                      child: ExpansionTile(
                    ...
                    Card(
                      ...
                      child: ExpansionTile(
                        ...
                        title: const Text('Compte & Classements'),
                        children: [
                          Consumer<GoogleIdentityService>(
                    ...
                    // Section À propos (sans bouton Version, déplacé dans Informations)
                    Card(
                      elevation: 0,
                      color: Colors.grey[50],
                      child: Column(
