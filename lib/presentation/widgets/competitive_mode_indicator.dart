...
// Cr̩er un nouveau fichier lib/widgets/competitive_mode_indicator.dart
  ...
  Widget build(BuildContext context) {
    return Consumer<GameState>(
      builder: (context, gameState, child) {
        // Ne rien afficher si ce n'est pas le mode comp̩titif
        if (gameState.gameMode != GameMode.COMPETITIVE) {
          return const SizedBox.shrink();
        }

        // Calculer le temps ̩coul̩ en mode comp̩titif
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text('Temps ̩coul̩: ${_formatDuration(gameState.competitivePlayTime)}'),
            const SizedBox(height: 16),
            const Text(
              'Objectif: Maximiser votre score avant l\'̩puisement du m̩tal mondial.',
