...
class UpgradesScreen extends StatelessWidget {
  ...
  Widget _buildUpgradeImpactPreview(String id, Upgrade upgrade, GameState gameState) {
    ...
    switch (id) {
      ...
      // Nouveau calcul avec 11% par niveau et plafond 85%
        ...
        // Calcul de la consommation de mÃ©tal avec les rÃ©ductions
        ...
        impacts['RÃ©duction de consommation'] = [
          _formatImpact(currentReduction),
          _formatImpact(nextReduction)
        ];

        impacts['Consommation de mÃ©tal'] = [
    ...
    // Le reste du widget reste inchangÃ©
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Flexible( // Ajout de Flexible pour gÃ©rer le dÃ©bordement
                          child: Text(
                            'Niveau ${gameState.level.level}',
                            style: TextStyle(
                              fontSize: 20, // Taille rÃ©duite
                              fontWeight: FontWeight.bold,
                              color: Colors.blue[700],
                            ),
                            overflow: TextOverflow.ellipsis, // Gestion du dÃ©bordement
                          ),
                        ),
                      ],
                    ),
                  ),
                  const SizedBox(height: 8), // Espacement rÃ©duit
                  ClipRRect(
                    borderRadius: BorderRadius.circular(10),
                    child: LinearProgressIndicator(
                      value: gameState.level.experienceProgress,
                      minHeight: 10, // Hauteur lÃ©gÃ¨rement rÃ©duite
    ...
    return Consumer<GameState>(
      builder: (context, gameState, child) {
        ...
        if (visibleElements['upgradesSection'] != true) {
          // Garder votre Ã©cran de verrouillage tel quel
          return const Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 16),
                Text(
                  'Continuez Ã  produire pour dÃ©bloquer cette section.',
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // Garde la mÃªme carte de statistiques mais avec une meilleure organisation
  ...
  Widget _buildRequirements(GameState gameState, Upgrade upgrade) {
    Map<String, bool> requirements = {
      ...
      'Argent requis: ${upgrade.getCost().toStringAsFixed(1)} â‚¬':
                  ...
                  children: [
                    ...
                    if (!isMaxed)
                      Container(
                        ...
                        child: Text(
                          '${upgrade.getCost().toStringAsFixed(1)} â‚¬',
                          style: TextStyle(
                            fontSize: 14,
