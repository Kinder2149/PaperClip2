...
// CrÃ©er un nouveau fichier lib/screens/competitive_result_screen.dart


// ModÃ¨le pour les scores des amis
class FriendScore {
  final String name;
  final int score;
...
class _CompetitiveResultScreenState extends State<CompetitiveResultScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _loadFriendScores() async {
    ...
    // Simuler un chargement (remplacer par l'appel rÃ©el aux scores des amis)
    await Future.delayed(const Duration(seconds: 1));

    // DonnÃ©es de test - Ã  remplacer par des donnÃ©es rÃ©elles
    final mockScores = [
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton.icon(
                ...
                label: const Text('Retourner Ã  l\'accueil'),
      ...
      child: Column(
        ...
        children: [
          ...
          _buildStatCard(
            ...
            detail: 'Jusqu\'Ã  la crise de mÃ©tal',
          ),
          ...
          _buildStatCard(
            ...
            detail: 'Avec une efficacitÃ© de ${widget.efficiency.toStringAsFixed(2)}',
          ),

          _buildStatCard(
            icon: Icons.euro,
            title: 'Argent accumulÃ©',
          ...
          _buildStatCard(
            ...
            detail: 'Plus de niveaux = plus de fonctionnalitÃ©s',
          ),

          const SizedBox(height: 16),

          // Graphique pour dÃ©composer le score
  ...
  Widget _buildScoreBreakdownChart() {
    // Calculer les pourcentages approximatifs pour la dÃ©composition du score
    ...
    return Column(
      ...
      children: [
        ...
        _buildLegendItem(Colors.green, 'Argent accumulÃ©'),
        _buildLegendItem(Colors.purple, 'Niveau atteint'),
        _buildLegendItem(Colors.orange, 'EfficacitÃ©'),
      ],
    );
  }
