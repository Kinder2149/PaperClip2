...
class _NewMetalProductionScreenState extends State<NewMetalProductionScreen> with SingleTickerProviderStateMixin {
  ...
  // Gardons votre onglet AperÃ§u (Missions JournaliÃ¨res) intact
                      ...
                      children: [
                        ...
                        if (allMissionsCompleted)
                          ElevatedButton.icon(
                            ...
                            label: const Text('RÃ©clamer Bonus'),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Divider(),
                  _buildStatRow('MÃ©tal StockÃ©',
                      '${formatNumber(gameState.player.metal)}/${formatNumber(gameState.player.maxMetalStorage)}'),
                  _buildStatRow('CoÃ»t de Maintenance',
                      '${gameState.player.maintenanceCosts.toStringAsFixed(2)} â‚¬/min'),
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    subtitle: const Text('Mettre Ã  jour tous les classements'),
                    trailing: const Icon(Icons.arrow_forward_ios),
                    onTap: () async {
                      gameState.updateLeaderboard();
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                          content: Text('Scores synchronisÃ©s !'),
        ...
        child: Column(
          ...
          children: [
            ...
            FutureBuilder<double?>(
              // Utilisez la constante du contrÃ´leur pour l'ID
                        ...
                        Padding(
                          ...
                          child: SizedBox(
                            ...
                            child: ElevatedButton.icon(
                              ...
                              label: Text(
                                'Acheter Autoclipper (${gameState.autocliperCost.toStringAsFixed(2)} â‚¬)',
                              ),
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Colors.deepPurple,
                                foregroundColor: Colors.white,
...
class NewMetalProductionScreen extends StatelessWidget {
