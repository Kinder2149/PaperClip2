...
class GameConstants {
  ...
  static const double MARKETING_UPGRADE_BONUS = 0.15; // +15% de demande par niveau de marketing (en plus du boost de base si utilisé)
  static const double REPUTATION_BONUS_PER_LEVEL = 0.10; // +10% de réputation par niveau
  static const double REPUTATION_BONUS_CAP = 0.5;        // +50% max
  static const double VOLATILITY_REDUCTION_PER_LEVEL = 0.08; // -8% d'impact de volatilité par niveau
  static const double VOLATILITY_REDUCTION_CAP = 0.5;        // -50% max
  static const double METAL_DISCOUNT_PER_LEVEL = 0.04;  // -4% sur le prix d'achat du métal par niveau
