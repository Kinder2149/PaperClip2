...
//
//   flutter test integration_test/multi_device_persistence_test.dart \
//     -d windows --timeout=120s
//
//   Note: "-d windows" évite le prompt de sélection de device.
//   Firebase nécessite le runner natif Flutter (platform channels) ;
//   ce test ne peut pas tourner en mode "flutter test" (VM dart pur).
//
...
void main() {
  // Initialise le binding integration_test (requis pour platform channels natifs)
